...
public enum ebCardState { drawpile, mine, dealercards, discard, target, ace }

public class CardBlackjack : cardbj
{ // Make CardProspector extend Card        // b
    [Header("Dynamic: CardProspector")]
    public ebCardState state = ebCardState.drawpile;                   // c
    ...
    public JsonLayoutSlotbj layoutSlot;
