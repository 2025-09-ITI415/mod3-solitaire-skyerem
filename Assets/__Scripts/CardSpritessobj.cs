...
menuName = "ScriptableObjects/CardSpritessobj")]         // a
public class CardSpritessobj : ScriptableObject
{                           // b
    [Header("Card Stock")]
    ...
    private static CardSpritessobj S;                                            // a
    ...
    static void INIT_STATICS(CardSpritessobj cSSO)
    {
        if (S != null)
        {
