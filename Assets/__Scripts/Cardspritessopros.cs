...
menuName = "ScriptableObjects/Cardspritessopros")]         // a
public class Cardspritessopros: ScriptableObject
{                           // b
    [Header("Card Stock")]
    ...
    private static Cardspritessopros Z;                                            // a
    ...
    static void INIT_STATICS(Cardspritessopros cSSO)
    {
        if (Z != null)
        {
        ...
        Z = cSSO; // Initialize the Singleton each time the game starts 
    ...
    {
        foreach (Sprite spr in Z.faceSprites)
        {
