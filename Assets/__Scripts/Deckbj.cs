...
[RequireComponent(typeof(JsonParseDeckbj))]
public class Deckbj : MonoBehaviour
{
    [Header("Inscribed")]
    public CardSpritessobj cardSprites;
    ...
    public List<cardbj> cards;

    private JsonParseDeckbj jsonDeck;
    ...
    */
    ...
    public void InitDeck()
    {
        ...
        jsonDeck = GetComponent<JsonParseDeckbj>();                            // b
    ...
    /// <returns></returns>
    cardbj MakeCard(char suit, int rank)
    {
        GameObject go = Instantiate<GameObject>(prefabCard, deckAnchor);   // f

        cardbj card = go.GetComponent<cardbj>();
    ...
    static public void Shuffle(ref List<cardbj> refCards)
    {
        // Create a temporary List to hold the new shuffle order
        List<cardbj> tCards = new List<cardbj>();
